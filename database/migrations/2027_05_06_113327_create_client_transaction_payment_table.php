...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('client_transaction_payment', function (Blueprint $table) {
            ...
            $table->foreign('client_full_name')->references('full_name')->on('client')->cascadeOnDelete();
            $table->foreign('transaction_id')->references('transaction_id')->on('transaction')->cascadeOnDelete();
