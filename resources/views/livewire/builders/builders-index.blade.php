<x-table title="Забудовники">
    ...
    <x-slot:filtration>
        <div class="inline mr-4">
            <x-label>Досвід</x-label>
            <div class="flex items-center">
                <x-input wire:model.live="min_experience" class="block mt-1 w-full min-w-20" type="number" min="0" max="0.01" />
                <span class="mx-2">-</span>
                <x-input wire:model.live="max_experience" class="block mt-1 w-full min-w-20" type="number" min="0" max="0.01" />
            </div>
        </div>

        <div class="inline mr-4">
            <x-label>Номер телефону</x-label>
            <x-input wire:model.live="phone_number" class="block mt-1 w-full" type="text" />
        </div>
    </x-slot:filtration>
