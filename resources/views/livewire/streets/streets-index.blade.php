    ...
    <x-slot:tbody>
        @foreach($items as $item)
            <tr>
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->road_surface }}</td>
                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->type_of_building }}</td>
