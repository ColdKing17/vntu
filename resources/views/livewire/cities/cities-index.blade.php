<x-table title="Міста">
    ...
    <x-slot:filtration>
        <div class="inline mr-4">
            <x-label>Населення</x-label>
            <div class="flex items-center">
                <x-input wire:model.live="min_population" class="block mt-1 w-full min-w-20" type="number" min="0" max="0.01" />
                <span class="mx-2">-</span>
                <x-input wire:model.live="max_population" class="block mt-1 w-full min-w-20" type="number" min="0" max="0.01" />
            </div>
        </div>

        <div class="inline mr-4">
            <x-label>Дата заснування</x-label>
            <x-input wire:model.live="date_of_establishment" class="block mt-1 w-full" type="date" />
        </div>
    </x-slot:filtration>
